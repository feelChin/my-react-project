            ...
            <div className={style.mineList}>
                ...
                <div className={style.mineListItem}>
                    ...
                    <div className={style.item}>
                        <div>
                            <i className="iconfont icon-didianPlaces12" style={{
                                color: "#1296db"
                            }}></i>
                            <sapn>地区</sapn>
                        </div>
                    ...
                    <div className={style.item}>
                        <div>
                            <i className="iconfont icon-nianling" style={{
                                color: "#2e57e8"
                            }}></i>
                            <sapn>年龄</sapn>
                        </div>
                    ...
                    <div className={style.item}>
                        <div>
                            <i className="iconfont icon-qianming" style={{
                                color: "#f4ea2a"
                            }}></i>
                            <sapn>笔名</sapn>
                        </div>
                    ...
                    <div className={style.item}>
                        <div>
                            <i className="iconfont icon-7" style={{
                                color: "#d81e06"
                            }}></i>
                            <sapn>邮箱</sapn>
                        </div>
                        <p><a href="mailto:chinqinji@gmail.com">{user && "chinqinji@gmail.com"}</a></p>
                    </div>
                </div>

                {
                    user && <>
                            ...
                            <div className={style.photo}>
                                {
                                    avatar && avatar.map((item, index) => {
                                        return (
                                            <img key={item.id} src={item.value} alt="" />
                                        )
                                    })
                                }
                            </div>
                        ...
                        <div className={style.mineListItem}>
                            ...
                            <div className={style.item}>
                                <div>
                                    <i className="iconfont icon-zhanghaoquanxianguanli" style={{
                                        color: "gray"
                                    }}></i>
                                    <sapn>账号</sapn>
                                </div>
